...
export default async function ReembolsoImprimivel({ params }: Props) {
  ...
  // Busca nomes dos clientes referenciados nos itens de deslocamento
                        ...
                        {tipo === "DESLOCAMENTO" && (
                          <>
                            <td className="px-3 py-2 text-center text-slate-600">
                              {item.km != null ? Number(item.km) : "—"}
                            </td>
                            <td className="px-3 py-2 text-center text-slate-600">
                              {item.valor_km != null ? `R$ ${Number(item.valor_km).toFixed(2)}` : "—"}
                            </td>
